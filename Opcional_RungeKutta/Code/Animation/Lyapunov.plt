...
set xrange [100 : 2000] # Ajusta el rango de tiempo según tus datos
set yrange [0:0.30]
...
plot for [archivo in list_archi] \
    archivo binary format='%double%double' using 1:2 with lines ls get_color_index(archivo) notitle, \
