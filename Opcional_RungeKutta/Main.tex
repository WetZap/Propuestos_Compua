...
Además, el código de Fortran utilizado para la simulación ha tenido que ser optimizado para poder realizar las simulaciones en tiempos razonables, lo que ha constituido una parte relevante del proceso de desarrollo. Esto ha sido un desafío interesante, ya que hemos tenido que encontrar formas de mejorar la eficiencia del código sin sacrificar la precisión de los resultados, lo que ha implicado un proceso de prueba y error para encontrar el equilibrio adecuado entre velocidad y precisión, así como el estudio de diferentes técnicas de optimización, como la vectorización y el uso de estructuras de datos eficientes y la paralelización de ciertas partes del código.
