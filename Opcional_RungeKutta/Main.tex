...
\centering
    ...
    \vspace{0.5cm}
     ...
     \normalfont\Large Grado en Física \\
    \vspace{0.5cm}
...
Aplicando las ecuaciones de Euler-Lagrange\footnote{La explicación de las ecuaciones se expone en el apéndice.}:
