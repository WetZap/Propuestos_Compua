...
\begin{equation}
\lambda = \frac{1}{t\ N}\sum_{i=0}^{N}  \ln \frac{d_{i}(t)}{d_{i}(0)}
\end{equation}
...
La separación inicial entre trayectorias se fijó en $d_0 = 10^{-8}$ (ajustar al valor real usado), y tras cada intervalo de integración las trayectorias se reescalan a esa separación inicial conservando su dirección, para evitar la saturación debida al carácter acotado del espacio de fases.
...
\begin{figure}[H]
    ...
    \caption{Gráfica de la energía inicial del sistema dividida por la energía calculada en cada paso de tiempo.}
    \label{fig:Energy}
\end{figure}
