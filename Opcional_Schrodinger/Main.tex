...
El codigo que se empleara en este proyecto se encuentra disponible en el siguiente repositorio de GitHub: \url{https://github.com/WetZap/Propuestos_Computacional/tree/main/Opcional_Schrodinger}
...
\begin{itemize}
    \item $\omega_{osc} = 200\ \&\&\ 800$: Frecuencia del oscilador armónico (Se considera 200 hasta que se diga lo contrario).
    \item $x_0 = 0.5$: Posición de equilibrio del oscilador armónico.
    \item $x_0^{gauss} = 0.3$ Desplazamiento de la función gaussiana.
    \item $\sigma = 1/16\ \&\& 1/10$: Ancho de la función gaussiana.
