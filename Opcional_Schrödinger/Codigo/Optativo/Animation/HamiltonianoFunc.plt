...
sigma = 1.0/16.0
x0 = 0.3
Hamiltoniano_teorico =  1.0/(2.0*sigma**2) + 0.25*omega**2 * (sigma**2/2.0 + (x0-0.5)**2)
...
plot archivo_entrada using 1:2 with lines linewidth 2 linecolor rgb "red" title "Evolución", \
     Hamiltoniano_teorico with lines linewidth 3 dashtype 2 linecolor rgb "blue" title "Teórico"
