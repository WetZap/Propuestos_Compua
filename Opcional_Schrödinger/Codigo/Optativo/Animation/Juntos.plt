...
# 5. Bucle de dibujo
do for [a=0:500-1] {
    plot archivo_entrada index a using 1:2 with lines linewidth 2 linecolor rgb "blue" title sprintf("Real: Frame %d", a), \
        archivo_entrada index a using 1:3 with lines linewidth 2 linecolor rgb "red" title sprintf("Imaginario: Frame %d", a)
